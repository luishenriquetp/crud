export const FakeData = [
  {
    id: '01',
    name: 'Café Pilão',
    img: 'https://www.paodeacucar.com/img/uploads/1/560/669560.png',
    qdt: 1,
    description:
      'Café torrado em grãos. Informação Adicional: O café Pilão Espresso, disponível na versão Pouch de 1kg, detém a combinação de grãos e ponto de torra que traduzem um café encorpado, aromático, levemente ácido e com creme espresso.',
  },
  {
    id: '02',
    name: 'Cerveja HEINEKEN Lata 350ml',
    img: 'https://static.paodeacucar.com/img/uploads/1/456/579456.png',
    qdt: 1,
    description: 'Água, malte e lúpulo. Graduação alcoólica: 5,0% vol.',
  },
  {
    id: '03',
